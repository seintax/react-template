...
const LandingPage = () => {
    ...
    return (
        <div className="w-[100%] h-[calc(100vh-100px)] text-[20px] text-white flex justify-center items-center isolate">
            <div className="w-[300px] h-[300px] bg-[#0f32cc] opacity-100 origin-center neubrutalism-plain rotate-[80deg] z-[-1] absolute"></div>
            <div className="w-[300px] h-[300px] bg-[#eeff01] opacity-100 origin-center neubrutalism-plain rotate-[60deg] z-[-1] absolute"></div>
            <div className="w-[300px] h-[300px] bg-[#03f2fa] opacity-100 origin-center neubrutalism-plain rotate-[40deg] z-[-1] absolute"></div>
            <div className="w-[300px] h-[300px] bg-[#07f807] opacity-100 origin-center neubrutalism-plain rotate-[20deg] z-[-1] absolute"></div>
            <div className="w-[300px] h-[300px] bg-[#ff04d5] opacity-100 origin-center neubrutalism-plain rotate-[0deg] z-[-1] absolute"></div>
            <div className="w-[300px] h-[300px] bg-transparent mt-[20px] flex flex-col justify-center items-center font-bold leading-[45px] absolute">
                ...
                <div className="text-[#ffffff] animate-bounce">HOMEPAGE</div>
