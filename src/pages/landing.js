...
const LandingPage = () => {
    ...
    return (
        <div className="w-[100%] h-[calc(100vh-100px)] text-[20px] text-white flex justify-center items-center isolate relative">
            ...
            <div className="bottom-[50px] absolute">
                <div className="px-[20px] py-[10px] bg-[#219aeb] hover:bg-[#0e8bdf] cursor-pointer" onClick={() => setnotify(true)}>View Topics</div>
                <div className="px-[20px] py-[10px] bg-[#219aeb] hover:bg-[#0e8bdf] cursor-pointer mt-[20px] flex justify-center" onClick={() => showPopper(`Welcome to the ${pagetitle}`, 1000)}>Click Me!</div>
            </div>
